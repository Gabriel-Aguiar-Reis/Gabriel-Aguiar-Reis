...
[![Linkedin: gabriel-aguiar](https://img.shields.io/badge/linkedin-gabrielaguiar-blue?style=flat-square&logo=Linkedin&logoColor=white&link=https://www.linkedin.com/in/o-gabriel-aguiar/)](https://www.linkedin.com/in/o-gabriel-aguiar/)
[![GitHub gabriel-aguiar](https://img.shields.io/github/followers/gabriel-aguiar-reis?label=follow&style=social)](https://github.com/gabriel-aguiar-reis)
...
const yourCompanySuccess = async () => {
  const potential = await hire(me)

  console.log(`Now, your company will have so much ${potential}!`)
}
```
---
